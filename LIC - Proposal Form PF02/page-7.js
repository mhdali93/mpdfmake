...
// F.   Where are you Resident for TAX purposes?  
// G.  Country / Countries of Tax Residence:  
// H.  Tax Reference Number(s):  
// I.  If you have answered ‘Yes’ to any of the above questions please complete requested additional details on Form B. If all the 
// answers are ‘No’, simply read and sign the declaration below. 
 
//  2. Declaration 
// I                                                                                                      acknowledge and declare that the above-mentioned information is correct and 
// true and complete to the best of my knowledge and belief. I agree to provide supporting evidence and provide updates in case any 
// of the aforementioned information changes. In case Life Insurance Corporation (International) B.S.C© (“the Insurer”) has any 
// reason to believe that the disclosed information is incorrect, the Insurer reserves the right to take suitable action against me.   
// Place:  
